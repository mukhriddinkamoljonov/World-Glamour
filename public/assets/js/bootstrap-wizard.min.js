(function (e) {
  ...
  Wizard.prototype = {
    ...
    _create: function (t) {
      ...
      this.submitCards = this.markup.find(
    ...
    autoDimensions: function () {
      ...
      this.dimensions.modal =
        this.dimensions.header + this.dimensions.navigation;
      ...
      this.dimensions.cardContainer =
        this.dimensions.body - this.dimensions.footer;
    ...
    errorPopover: function (e, t, n) {
      ...
      var r = e
        .popover({
          ...
          trigger: "manual",
          html: n,
          container: e.parents(".form-group"),
        })
        .addClass("error-popover")
        .popover("show")
        .next(".popover");
