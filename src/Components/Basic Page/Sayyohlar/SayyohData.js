  ...
  [
    {
      ...
      info: (
        <div>
          ...
          <strong> {t("useful24")} </strong> {t("useful25")} <br /> <strong> {t("useful26")} </strong>{" "}
          {t("useful27")}
        </div>
      ),
    ...
    },
    {
      ...
      info: (
        <div>
          ...
          <br /> <strong>{t("useful31")}</strong>{t("useful32")} <br />{" "}
          <strong>{t("useful33")}</strong> {t("useful34")} <br />{" "}
          <strong>{t("useful35")}</strong> {t("useful36")}
          <br /> <strong>{t("useful37")}</strong>{t("useful38")}
          <br />
          <strong> {t("useful39")}</strong> {t("useful40")}
          <br />
          <strong> {t("useful41")} </strong>{t("useful42")} <br />{" "}
          <strong>{t("useful43")} </strong>{t("useful44")} 
          <br />
          <strong> {t("useful45")}  </strong>{t("useful46")} 
          <br />
    ...
    },
    {
      ...
      info: (
        <div>
          ...
          <a href="https://e-visa.gov.uz/main">"e-visa.gov.uz</a> <strong>{t("useful51")}</strong> {" "}
